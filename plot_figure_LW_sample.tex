...
\hfill
\rotatebox[origin=c,x=12pt,y=98pt]{270}{\includegraphics[width = 0.182\textwidth]{./figure/LW/324001.ps}}
\end{figure*}
\begin{figure*}[!ht]
\centering
...
\hfill
\rotatebox[origin=c,x=12pt,y=98pt]{270}{\includegraphics[width = 0.182\textwidth]{./figure/LW/153001.ps}}
\end{figure*}
\end{document}
