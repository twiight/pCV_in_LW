...
The flux ratio and its 90\% error are similarly determined for these two sources, resulting in $I_{7.0}/I_{6.7} = 0.91^{+0.38}_{-0.60}$ ($0.51^{+0.80}_{-0.47}$) for LW21 (LW23).   
