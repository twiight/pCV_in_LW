...
%{\bf [we don't have to discard foreground sources at this point]}
...
The phase-folded light curve at the two modulation periods, the long-term, inter-observation light curve and the spectra (Section~\ref{sec:spectra}) of these two sources are shown in Figure~\ref{fig:} and Figure~\ref{fig:}. {\bf [a 4-panel plot for each source}
