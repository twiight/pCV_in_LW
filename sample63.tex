...
In this section, we first provide our motivation of employing the Gregory-Loredo (GL) algorithm, followed by a description of its basic principles. We then elucidate our application of the algorithm to the {\it Chandra} data of the LW. This is complemented by a procedure of evaluating the detection (in)completeness.  
