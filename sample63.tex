...
\begin{figure*}[!ht]
  ...
  \captionsetup{list=off,format=cont}
    \centering
    \includegraphics[page=1,scale=0.90,trim=0 470 0 70,clip]{plot_figure_LW_sample.pdf}
