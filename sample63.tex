...
In order to examine the detection rate for GL method, we did numerous simulations. The routine follows as described by \citep{1998ApJ...498..666C}. We took sinusoidal variation for a specific counts rate. Since the limit of computational power, the simulation were run at limited numbers of parameters. 
The intrinsic light curve follows,
\begin{equation}
\lambda (t)=\lambda_0 \times [1+A_{0}sin(\omega t)], 
\label{eqn:sin}
\end{equation}
...
We casually chose three period in different period ranges, which was 554s, 5540s, 45540s. The values were not chosen by any physical reasons. These three period represent the performance of GL method in three period ranges. 
