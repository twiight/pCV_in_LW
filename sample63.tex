...
\colhead{Period} & \colhead{$P_{GL}$} & \colhead{H-ID} & \colhead{Counts} &\colhead{$A_0$} & \colhead{$P_{det}$}  &\colhead{$P_{det}'$} & \colhead{VI}&\colhead{harmonics}\\
\colhead{LW} & \colhead{$\circ$} & \colhead{($\circ$)} & 
\colhead{(s)} & \colhead{} & \colhead{} & \colhead{1-8 keV} & \colhead{} & \colhead{} &\colhead{\%}   &\colhead{} &\colhead{}
}
\decimals
\decimalcolnumbers
\startdata
